...
export const AppLayout: React.FC<AppLayoutProps> = ({ currentPath, onNavigate, children }) => {
  ...
  const navigationGroups: { title: string; groupId?: string; items: NavItem[] }[] = [
    ...
    },
    {
      ...
      groupId: 'gestao-juridica',
      items: [
        {
          id: 'clientes',
          label: 'Clientes & Processos',
        ...
        },
        {
          ...
          path: '/advogados',
          permission: 'advogados.view',
        },
      ],
    },
    {
      title: 'Acompanhamento & Prazos',
    ...
    },
    {
      ...
      items: [
        ...
        },
        {
          ...
          path: '/status-processos',
          permission: 'status-processos.view',
        },
        {
          id: 'logs',
